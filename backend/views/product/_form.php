    ...
    <?php $form = ActiveForm::begin(); ?>
        ...
        <ul class="nav nav-tabs">
            ...
            <?php
                ...
                <li><a data-toggle="tab" href="#options">Характеристики</a></li>
        ...
        <div class="tab-content">
            <div id="main" class="tab-pane fade in active">
                <p>
                    ...
                    <?= $form->field($model, 'category')->dropDownList($model->getCategoriesDropDown(), $model->getCategoriesDropDownParams($model->category)) ?>
                    <?= $form->field($model, 'brand_id')->dropDownList($model->getBrandsDropDown(), $model->getBrandsDropDownParams($model->brand_id)) ?>
                    <?= $form->field($model, 'status')->checkbox(['label' => 'Active'])?>
                    <?= $form->field($model, 'code')->textInput() ?>
                    <?= $form->field($model, 'model')->textInput() ?>
                    <?= $form->field($model, 'unit')->textInput() ?>
                    <?= $form->field($model, 'preview_text')->textarea(['rows' => 3]) ?>
                            ...
                            <div class="col-md-6">
                                ...
                                if (!$model->isNewRecord) {
                                    ...
                                    Pjax::begin(['enablePushState' => false]);
                                        ...
                                        echo Html::a('Добавить', '', ['class' => 'btn btn-primary btn-add-value']);
